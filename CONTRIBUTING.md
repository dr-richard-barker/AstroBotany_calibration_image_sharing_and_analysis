# Contributing to AstroBotany Calibration Image Hub

Thank you for contributing to the AstroBotany Calibration Image Sharing and Analysis Hub! This repository hosts a static web application built with **React**, **TypeScript**, and **Vite** that provides browser-based analysis of plant photographs taken next to the AstroBotany calibration marker.
...
git clone https://github.com/dr-richard-barker/AstroBotany_calibration_image_sharing_and_analysis.git
cd AstroBotany_calibration_image_sharing_and_analysis
...
| `genotype` | string | Plant mutant line, accession, or ecotype |
